...
def main(Odeltaonebod, Odeltatwobod, energy=86):
    ...
    # print("Odeltaonebod, Odeltatwobod=", Odeltaonebod, Odeltatwobod)
        ...
        for betaDiff in [-2, 0, 2]:
                ...
                for lambdaSRG in lambdaSRGs:
                    for lambdaCut in lambdaCuts:
                        try:
                            ...
                            ccs.append(crossSec["cc"])
                            outDict[(lambdaSRG, lambdaCut)].append(
                                [float(theta), crossSec["cc"]]
                            )
                            outFiles[
                                (
                                    theta,
            ...
            match energy:
                ...
                case 75:
                    data = None
                case _:
                    raise ValueError(f"energy={energy} not recognised")
...
if __name__ == "__main__":
    ...
    ones = ["Odelta0", "Odelta2", "Odelta3", "Odelta3"]
    twos = ["Odelta0", "Odelta2", "Odelta2", "Odelta4"]
    # for energy in [60, 86]:
    for energy in [60, 75, 86, 100]:
