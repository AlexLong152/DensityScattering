...
c*********************************************************************
      ...
      real*4, allocatable :: p12Read(:), rhoRead(:,:,:)
...
c     
      ...
      integer j12max,numDiagrams            ! max total ang mom in (12) subsystem -- =1 suffices for 1% accuracy.
...
c     0: do not delete; 1: delete un-gz'd file; 2: delete downloaded and un-gz'd file 
      ...
      integer NPA_large,NPB_large,NP_large
      real*8, allocatable :: rho_large(:,:,:)
      integer rho_large_shape(3)
      real*8 P12MAG_large(50),AP12MAG_large(50)
      integer tmpi, tmpj
