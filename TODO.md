...
##3. varsub in general
There are many files that are repeated in the varsub version of density modules that have not been modified at all. **This should be
fixed so that if a change is made it only has to be made in one place.**
