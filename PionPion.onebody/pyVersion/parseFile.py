...
def getFileData():
    ...
    letter_map = {"S": 0, "P": 1, "D": 2, "F": 3, "G": 4, "H": 5, "I": 6, "J": 7}
    ...
    with open(file, "r") as f:
        for line in f:
            # Detect headers like "S11", "D13", "F15", and treats "I313" as letter, number, two digit number
            header_match = re.search(r"\b([SPDFGHIJ])(\d)(\d{1,2})\b", line)
            if header_match:
...
if __name__ == "__main__":
    ...
    if len(argv) == 1:
        ...
        a, b = dataDict[0][1][1][1080.00]
        print(a * 180 / np.pi, b)
        print("should be .43, 0")
        a, b = dataDict[3][3][7][1296]
        print(a * 180 / np.pi, b)
