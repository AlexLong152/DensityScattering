...
c     ================================================================
      subroutine getCS(sqrtS, x, isospin, piCharge, CrossSec,mNucl)
...
c     ================================================================
      subroutine getCSPYCheck(sqrtS, x, isospin, piCharge, CrossSec,
     &                        mNucl)
c     Calculate cross section from scattering matrix (corrected version)
c     This version fixes the indexing bug in getCS for comparison with Python
c     ================================================================
      implicit none
      double precision sqrtS, x, CrossSec,mNucl
      integer isospin, piCharge
...
c     Calculate matDag manually for (-1:1,-1:1) indexing
      do i = -1, 1, 2
        do j = -1, 1, 2
...
c     TODO: why isn't this m2 mNucl instead?
      m2=mNucl
